...
model = dict(
    ...
    transformer = dict(type='LSS_PON_ra',use_light = True),
    decode_head=dict(
        type='Polarhead',
        num_classes=8,
        align_corners=True),
...
load_from = r"/public/home/HFT/models_dir/DARAR/iter_80000.pth"
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        type='ArgoverseDataset',
        data_root='/public/home/xyx_20241401014/HFT/data/argoversev1.0/',
        img_dir='img_dir/val',
